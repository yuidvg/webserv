...
curl_commands=(
    ...
    "curl -X DELETE http://${SERVER_ADDRESS}/uploadPath/upload.txt 200"
    ...
    "curl -X GET http://${SERVER_ADDRESS}/nothing 400"
    "curl -X GET http://${SERVER_ADDRESS}/ -H 'Host: localhost\r\n' 200"
    "curl -X GET http://${SERVER_ADDRESS}/ -H 'Host:localhost\r\n' 400"
    "curl -X GET http://${SERVER_ADDRESS}/ -H '' 400"
    "curl -X POST http://${SERVER_ADDRESS}/uploadPath/test -H 'Host: localhost\r\nContent-Length: 0' -d \"\" 200"
